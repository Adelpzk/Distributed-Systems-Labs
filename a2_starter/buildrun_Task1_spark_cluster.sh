...
export TARGET=in0.txt   # change this to the server file you want to test
...
rm out/t1_${TARGET}
$HADOOP_HOME/bin/hdfs dfs -cat $OUTPUT/* | sort > ~/ece454-assignments/a2_starter/out/t1_${TARGET}
diff a2_output/t1_${TARGET} out/t1_${TARGET}