...
#INPUT=/tmp/a2_inputs/small_data/
INPUT=/a2_inputs/in0.txt
#INPUT=/tmp/a2_inputs/medium_data/
...
time $SPARK_HOME/bin/spark-submit --master local[2] --class SparkWC --driver-memory 1g --executor-memory 1g SparkWC.jar $INPUT $OUTPUT
