...
public class A3Client implements CuratorWatcher {
	...
	primaryAddress = null;
	exlog = new ExecutionLogger("grader_execution.log");
    }
	...
	throw new Exception("Exceeding time");
    }

    KeyValueService.Client getThriftClient() throws Exception {
	while (!done) {
	    try {
